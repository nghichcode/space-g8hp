...
from NCI2T_IO import ncio
import NCI2T_Lib as ncl
...
class NCBox ( wx.Dialog ):
	def __init__(self, tbody, *args, **kw):
		...
		self.hpl = hl.HyperLinkCtrl(self, -1, "NCI2T", URL="https://nghichcode.com/")
...
class NcImageCheck ( wx.Frame ):
	...
	def __init__(self, *args, **kw):
		...
		self.mitGuide = wx.MenuItem( self.m_menu2, wx.ID_ANY, u"Guide", "\tNCI2T User Guide", wx.ITEM_NORMAL )
		self.mitExit = wx.MenuItem( self.m_menu2, wx.ID_ANY, u"Exit", "\tExit NCI2T", wx.ITEM_NORMAL )
		...
		self.mitAbout = wx.MenuItem( self.m_menu3, wx.ID_ANY, u"About", "\tInformation About NCI2T", wx.ITEM_NORMAL )
	...
	def ncth(self,cpfdo,cpfou, *kws):
		pcrt,ipsx,ipsy,ipex,ipey = kws
		for rs in ncl.get_data(cpfdo,cpfou, pcrt,ipsx,ipsy,ipex,ipey):
			global STOP_THREAD
	...
	def start_compare( self, event ):
		...
		btn.Disable()
		NC_TH=Thread(target=self.ncth, args=(OLD_FOLD,OUT_FOLD, pcrt,ipsx,ipsy,ipex,ipey))
		NC_TH.start()
